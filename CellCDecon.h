...
void update_weights(float **infer_weight, float* max_weights, float* min_weights, float **obs_mat, float **infer_mean, float **infer_var, int *iters_unconsidered_ind, int* iters_unchanged_ind, int max_unchanged_ind, int max_unconsidered_ind, int k, int nsamp, int nprobe, float *logTable, float gamma ) ;
